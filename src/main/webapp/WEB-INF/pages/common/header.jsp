...
<div class="movie-header all-container" >
    ...
    <%--后台登录链接--%>
    <a href="/WEB-INF/pages/user/login.jsp" target="_blank" style="position: absolute;right: 50px;top: 0;line-height: 60px;">
        <span style="text-align: center;vertical-align: middle;color: #FF572f;">进入后台</span>
    </a>

    <script src="/static/layui/css/modules/layer/default/layer.css" charset="utf-8"></script>
    <script>
        /**
         * 用户信息模块
         */
