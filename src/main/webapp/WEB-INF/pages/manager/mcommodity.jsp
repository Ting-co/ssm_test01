...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <%--搜索框--%>
        <div style="">
            <form class="layui-form layui-form-pane" action="Mcommoditys/select">
            ...
            <div style="padding:20px;">
                <table id="demo" lay-filter="demo">
                    ...
                    <tr>
                        ...
                        <th lay-data="{field:'uid',align: 'center'}">用户id</th>
                    ...
                    <c:forEach items="${commoditys}" var="obj">
                        <tr>
                            ...
                            <td>${obj.message}</td>
                            <td>
                                <a href="Mcommoditys/look/${obj.sid}" class="operateBtn">查看</a>
                                <a class="operateBtn" lay-event="update" objId="${obj.sid}">编辑</a>
                                <a class="operateBtn" lay-event="dispass" objId="${obj.sid}">不通过</a>
                                <a class="operateBtn" lay-event="delete" objId="${obj.sid}">删除</a>
                                <a class="operateBtn" lay-event="pass" objId="${obj.sid}">通过</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
    ...
    <div style="border:1px solid #eee ;margin: 0 auto;max-width: 1140px;padding-top: 10px;display: none;"
        ...
        <form class="layui-form layui-form-pane" action="Mcommoditys/update">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">商品库存</label>
                <div class="layui-input-inline">
                    <input type="text" id="amount" name="amount" lay-verify="required" placeholder="个" autocomplete=""
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="state" lay-verify="required">
                        <option id="state" selected:disabled style="diaplay:none" value=""></option>
                        <option value="0">无货</option>
                        <option value="1">在审核中</option>
                        <option value="2">不通过</option>
                        <option value="3">待售卖</option>
                        <option value="4">售卖中</option>
                    </select>
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea id="umessage" name="message" class="layui-textarea"></textarea>
                </div>
            </div>
    ...
    <div style="border:1px solid #eee ;margin: 0 auto;max-width: 1140px;padding-top: 10px;display: none;"
         id="dispass">
        <form class="layui-form layui-form-pane" action="Mcommoditys/dispass">
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">审核留言</label>
                <div class="layui-input-block">
                    <textarea id="message" name="message" required class="layui-textarea"></textarea>
                </div>
            </div>

            <input id="ssid" type="hidden" name="sid" value=""/>
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (layEvent == 'delete') {
                ...
                layer.confirm('确认删除商品 \"' + data.commodity + '\" ?', {title: '提示'}, function (index) {
                    $.get('Mcommoditys/delete?sid=' + id1, function (data) {
                        if (data >= 1) {
                            layer.msg("删除成功");
                            obj.del();
                        } else {
                    ...
                    , success: function () {
                        ...
                        $.ajax({
                            ...
                            , success: function (data) {
                                ...
                                document.getElementById("umessage").value = data.message;
